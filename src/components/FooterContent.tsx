    ...
    <div className="py-12 lg:py-16">
      <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-text/80 leading-relaxed">
              Software factory especializada en crear productos digitales escalables 
              con inteligencia artificial y diseño moderno.
            </p>
        ...
        >
          ...
          <nav className="space-y-3">
            <a href="#sobre-nosotros" className="block text-text/80 hover:text-primary transition-colors">
              Sobre nosotros
            </a>
            <a href="#proyectos" className="block text-text/80 hover:text-primary transition-colors">
              Proyectos
            </a>
            <a href="#servicios" className="block text-text/80 hover:text-primary transition-colors">
              Servicios
            </a>
            <a href="#contacto" className="block text-text/80 hover:text-primary transition-colors">
              Contacto
            </a>
          </nav>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-text/80">Respuesta en 24hs</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      >
        <p className="text-text/60 text-sm">
          © 2024 Wonkai. Todos los derechos reservados.
        </p>
